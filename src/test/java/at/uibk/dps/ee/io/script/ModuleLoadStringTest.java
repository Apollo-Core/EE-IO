...
public class ModuleLoadStringTest {
  ...
  public void testStringInput() {
    ...
    try {
      Class<? extends Module> classSpecModule =
          Class.forName(specInputName).asSubclass(Module.class);
      Class<? extends Module> classInputModule =
          Class.forName(inputModuleName).asSubclass(Module.class);
      Class<? extends Module> classOutputModule =
          Class.forName(outputPrinterName).asSubclass(Module.class);
